...
export default async function InicioPrevio() {
  ...
  // ¿Esta persona todavía no es cliente de ningún negocio? La regla de a dónde
  // llevarla vive en `modules/cliente/primerPaso`, fuera de esta pantalla: así
  // se prueba por comportamiento y sobrevive a que el Inicio se reescriba.
  const sinEmpresa = !companyId
  const paso = primerPaso({ companyId, marcaUnica })
