...
import { establecerContrasenaCliente } from '@/modules/excursiones/cliente/actions'
...
function EstablecerContrasenaForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    const result = await establecerContrasenaCliente(token!, password)
    setLoading(false)
  ...
  return (
    <Card className="border-border">
      <CardHeader>
        ...
        <CardDescription>
          Se te ha creado una cuenta en MembeGo. Establece tu contraseña para acceder a tu panel.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {success ? (
