 ...
 *
 * ────────────────────────────────────────────────────────────────────────────
 * SIN FILA DE INDICADORES
 *
 * El rediseño quita los cuatro números de arriba: «3 conectadas · 2
 * disponibles» repetía lo que las pestañas ya cuentan y empujaba la rejilla
 * —que es lo que se viene a ver— debajo del pliegue. Lo único que se queda
 * por encima del catálogo es el aviso de lo que pide atención, porque quien
 * entra con una integración rota no debería tener que buscarla.
 *
 * TODO lo que se ve aquí sale de `catalogoDeEmpresa`, que es también de donde
 * salen la página de detalle y el bloque que aparece dentro de Citas. Una sola
 * verdad, tres pantallas.
 */
