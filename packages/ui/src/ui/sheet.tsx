...
/**
 * Sheet (drawer lateral) construido sobre Radix Dialog, igual que en
 * shadcn/ui: mismo overlay y semántica modal, pero el contenido se desliza
 * desde un borde de la pantalla en vez de centrarse.
 */
